...
CREATE TABLE IF NOT EXISTS productos (
  ...
  categoria VARCHAR(40) NOT NULL CHECK (
    categoria IN (
      'suplementos','articulos deportivos','servicios personalizados',
      'maquinas y equipos','ropa deportiva','accesorios','otros'
    )
  ) DEFAULT 'otros',
...
CREATE TABLE IF NOT EXISTS pedidos (
  ...
  estado VARCHAR(25) NOT NULL DEFAULT 'pendiente' CHECK (
